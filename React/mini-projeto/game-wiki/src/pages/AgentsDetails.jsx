...
const AgentsDetails = () => {
    ...
    if (loading) return <div className="text-white text-center mt-20">Carregando agente...</div>;
    if (!champion) return <div className="text-white text-center mt-20">Agente não encontrado.</div>;
    ...
    return (
        <div className="bg-zinc-950 min-h-screen text-white p-10 flex flex-col items-center">
            <div className="max-w-4xl w-full">
                ...
                <h2 className="text-2xl font-bold mb-6 border-b border-zinc-800 pb-2">Habilidades</h2>
                ...
                <div className="flex flex-col gap-8">
                    {champion.spells.map((spell) => (
                        ...
                        >
                            {spell.image && (
                                <img src={spell.image} alt={spell.name} className="w-16 h-16 rounded-lg" />
                            )}
                            <div>
